        ...
        <div class="container-top">
          ...
          <?php endif; ?>
           <?php wp_reset_postdata(); ?>
            ...
            ?>
              <a href="<?php echo esc_url($category_link); ?>" class="news-articles_link_text"
                >インタビューの一覧はこちら→</a
              >
            </p>
          </div>
            ...
            <div class="news-contain">
              <ul>
                ...
                <li class="news-list">
                  ...
                  <a href="<?php the_permalink(); ?>" class="new-title">
                  <?php the_title(); ?>
                </a>
                </li>
              ...
              <p class="news-articles_link">
                <a href="<?php echo get_post_type_archive_link('news'); ?>" class="news-articles_link_text"
                  >ニュース一覧はこちら→</a>
              </p>
            </div>
          </div>
